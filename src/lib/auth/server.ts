...
export const auth = betterAuth({
  ...
  // Seller devices should stay signed in across app restarts (Capacitor + browser).
  // 30-day session; cookie cache still short so profile updates propagate quickly.
  session: {
